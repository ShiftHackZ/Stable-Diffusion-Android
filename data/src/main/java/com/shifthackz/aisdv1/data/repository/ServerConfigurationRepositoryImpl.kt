...
internal class ServerConfigurationRepositoryImpl(
    ...
    override fun fetchAndGetConfiguration(): Single<ServerConfiguration> = fetchConfiguration()
        .onErrorComplete()
        .andThen(getConfiguration())

    override fun getConfiguration(): Single<ServerConfiguration> = localDataSource.get()

    override fun updateConfiguration(configuration: ServerConfiguration): Completable = remoteDataSource
