...
class InPaintStateProducer {
    ...
    fun observeInPaint(): Flowable<InPaintModel> = inPaintSubject.toFlowable(BackpressureStrategy.LATEST)

    fun observeBitmap(): Flowable<Bitmap> = bitmapSubject.toFlowable(BackpressureStrategy.LATEST)
