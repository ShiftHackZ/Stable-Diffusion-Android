...
/**
 * Defines the `LinksProvider` contract for the SDAI core common layer.
 *
...
interface LinksProvider {
     ...
     * @author Dmitriy Moroz
     */
    val developerWebsiteUrl: String
    /**
